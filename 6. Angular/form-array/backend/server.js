...
app.post('/api/submit', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, username, email, position, skills, query, values, result, error_1;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                _a = req.body, username = _a.username, email = _a.email, position = _a.position, skills = _a.skills;
                _b.label = 1;
            case 1:
                _b.trys.push([1, 3, , 4]);
                query = "\n      INSERT INTO job_applications (username, email, position, skills)\n      VALUES ($1, $2, $3, $4)\n      RETURNING *;\n    ";
                values = [username, email, position, JSON.stringify(skills)];
